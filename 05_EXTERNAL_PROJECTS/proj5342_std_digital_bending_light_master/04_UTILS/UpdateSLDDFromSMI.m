...
SMIPath = "./03_DOC/04_SMI/ADB_Master_SMI.xlsx";
...
InputsTable = readtable(SMIPath, 'Sheet', 'Inputs', 'TextType', 'String');
OutputsTable = readtable(SMIPath, 'Sheet', 'Outputs', 'TextType', 'String');
RunnablesTable = readtable(SMIPath, 'Sheet', 'Runnables', 'TextType', 'String');
PublicDataTable = readtable(SMIPath, 'Sheet', 'PublicData', 'TextType', 'String');
